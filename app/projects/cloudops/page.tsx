...
export default function CloudOpsPage() {
  return <main className="cloudops-page">
    <nav><Link href="/#projects">← 返回项目案例</Link><span>独立交付项目 / 2026.07—至今</span><a href="/resume.pdf">查看简历 →</a></nav>
    ...
    <footer><Link href="/#projects">← 返回全部项目</Link><span>CloudOps / 独立交付项目</span><a href="/resume.pdf">查看 PDF 简历 →</a></footer>
  </main>;
}
